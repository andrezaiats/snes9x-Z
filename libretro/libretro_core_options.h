...
struct retro_core_option_definition option_defs_us[] = {
   ...
   {
      "snes9x_threaded_render",
      "Threaded Renderer (restart required)",
      "Run the PPU pixel renderer on a dedicated thread. Enabled by default: every game in this fork's bench corpus measured a positive, statistically significant gain (95% CI excludes a regression worse than -2%), from +6.9% to +57.5% on x86-64. May cost more than it buys on a single-core system; requires a core restart to take effect.",
      {
         { "enabled",  NULL },
         { "disabled", NULL },
         { NULL, NULL},
